...
def run_pipeline(args: argparse.Namespace) -> None:
    try:
        ...
        command = f"cd {args.outdir}; snakemake --use-conda --nolock --cores all -s {os.path.join(os.path.dirname(__file__),'pipeline.smk')} --config {sample_var} component_name={COMPONENT['name']}"
        print(command)
